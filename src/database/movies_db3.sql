...
--
-- Host: localhost    Database: movies_db3
-- ------------------------------------------------------
...
CREATE TABLE `actor_episode` (
  ...
  PRIMARY KEY (`id`),
  KEY `actor_episode_actor_id_foreign` (`actorId`),
  KEY `actor_episode_episode_id_foreign` (`episodeId`),
  CONSTRAINT `actor_episode_actor_id_foreign` FOREIGN KEY (`actorId`) REFERENCES `actors` (`id`),
  CONSTRAINT `actor_episode_episode_id_foreign` FOREIGN KEY (`episodeId`) REFERENCES `episodes` (`id`)
...
CREATE TABLE `episodes` (
  ...
  PRIMARY KEY (`id`),
  KEY `episodes_season_id_foreign` (`seasonId`),
  CONSTRAINT `episodes_season_id_foreign` FOREIGN KEY (`seasonId`) REFERENCES `seasons` (`id`)
...
CREATE TABLE `seasons` (
  ...
  `serieId` int(10) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `seasons_serie_id_foreign` (`serieId`),
  CONSTRAINT `seasons_serie_id_foreign` FOREIGN KEY (`serieId`) REFERENCES `series` (`id`)
...
CREATE TABLE `series` (
  ...
  `genreId` int(10) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `series_genre_id_foreign` (`genreId`),
  CONSTRAINT `series_genre_id_foreign` FOREIGN KEY (`genreId`) REFERENCES `genres` (`id`)
...
--
-- Dumping routines for database 'movies_db3'
--
...
-- Dump completed on 2021-12-02 10:46:26
